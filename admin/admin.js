...
var _user$project$Types$Post = F7(
	function (a, b, c, d, e, f, g) {
		return {slug: a, uuid: b, title: c, html: d, markdown: e, publishedAt: f, updatedAt: g};
	});
...
var _user$project$Types$GotPosts = function (a) {
	return {ctor: 'GotPosts', _0: a};
};
var _user$project$Types$FetchPost = function (a) {
	return {ctor: 'FetchPost', _0: a};
};
var _user$project$Types$FetchPosts = {ctor: 'FetchPosts'};

var _user$project$Parse$parseDate = function (str) {
	return _elm_lang$core$Result$toMaybe(
		_jweir$elm_iso8601$ISO8601$fromString(str));
};
var _user$project$Parse$nullOr = function (decoder) {
...
var _user$project$Parse$decodePost = A8(
	...
	A2(
		...
		_elm_lang$core$Json_Decode$oneOf(
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$core$Json_Decode$null(_elm_lang$core$Maybe$Nothing),
					A2(_elm_lang$core$Json_Decode$map, _user$project$Parse$parseDate, _elm_lang$core$Json_Decode$string)
				]))),
	A2(
		_elm_lang$core$Json_Decode$map,
		function (_p0) {
			return A2(
				...
				_user$project$Parse$parseDate(_p0));
		},
		A2(_elm_lang$core$Json_Decode_ops[':='], 'updatedAt', _elm_lang$core$Json_Decode$string)));
var _user$project$Parse$decodeOnePost = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['post']),
	_user$project$Parse$decodePost);
var _user$project$Parse$decodeAllPosts = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['posts']),
	_elm_lang$core$Json_Decode$list(_user$project$Parse$decodePost));

var _user$project$Api$getOnePost = function (url) {
	var request = {
		verb: 'get',
		url: A2(_elm_lang$core$Basics_ops['++'], '/api/post/', url),
		headers: _elm_lang$core$Native_List.fromArray(
			[
	...
	var task = A2(_evancz$elm_http$Http$send, _evancz$elm_http$Http$defaultSettings, request);
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Types$FetchFail,
		_user$project$Types$GotPost,
		A2(_evancz$elm_http$Http$fromJson, _user$project$Parse$decodeOnePost, task));
};
var _user$project$Api$getAllPosts = function () {
	var request = {
		verb: 'get',
		url: '/api/post/',
		headers: _elm_lang$core$Native_List.fromArray(
	...
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Types$FetchFail,
		_user$project$Types$GotPosts,
		A2(_evancz$elm_http$Http$fromJson, _user$project$Parse$decodeAllPosts, task));
}();

var _user$project$State$headMay = function (l) {
	return _elm_lang$core$Native_Utils.eq(
		_elm_lang$core$List$length(l),
		0) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$List$head(l);
};
var _user$project$State$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'FetchPosts':
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Api$getAllPosts};
			case 'FetchFail':
				return A2(
					_elm_lang$core$Debug$log,
			...
			case 'FetchPost':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Api$getOnePost(_p0._0)
				};
			case 'GotPosts':
				var modelPosts = _elm_lang$core$Dict$fromList(
					A2(
						_elm_lang$core$List$map,
						function (p) {
							return {ctor: '_Tuple2', _0: p.slug, _1: p};
						},
						_p0._0));
				return {
					ctor: '_Tuple2',
					_0: {
						posts: _elm_lang$core$Maybe$Just(modelPosts),
			...
			default:
				var _p2 = _p0._0;
				var _p1 = A2(_elm_lang$core$Debug$log, 'selecting post ', _p2.title);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							selectedPost: _elm_lang$core$Maybe$Just(_p2)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
...
var _user$project$State$init = {
	ctor: '_Tuple2',
	_0: {posts: _elm_lang$core$Maybe$Nothing, selectedPost: _elm_lang$core$Maybe$Nothing},
	_1: _user$project$Api$getAllPosts
};

var _user$project$View$isNothing = function (a) {
	var _p0 = a;
	if (_p0.ctor === 'Nothing') {
		return true;
	} else {
...
var _user$project$View$lift = F2(
	function (func, thing) {
		var _p1 = thing;
		if (_p1.ctor === 'Nothing') {
			return _elm_lang$core$Maybe$Nothing;
...
var _user$project$View$sortPublishedAt = F2(
	function (a, b) {
		var _p2 = {ctor: '_Tuple2', _0: a.publishedAt, _1: b.publishedAt};
		if (_p2._0.ctor === 'Nothing') {
			if (_p2._1.ctor === 'Nothing') {
				return A2(
					_elm_lang$core$Basics$compare,
					_jweir$elm_iso8601$ISO8601$toTime(b.updatedAt),
					_jweir$elm_iso8601$ISO8601$toTime(a.updatedAt));
			} else {
			...
			if (_p2._1.ctor === 'Nothing') {
				...
				return A2(
					_elm_lang$core$Basics$compare,
					_jweir$elm_iso8601$ISO8601$toTime(_p2._1._0),
					_jweir$elm_iso8601$ISO8601$toTime(_p2._0._0));
			}
		}
	});
var _user$project$View$renderPostEdit = function (maybePost) {
	var content = function () {
		var _p3 = maybePost;
		if (_p3.ctor === 'Nothing') {
			return _elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('No post selected')
				]);
		} else {
			return _elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text(
					A2(_elm_lang$core$Basics_ops['++'], 'editing: ', _p3._0.title))
				]);
		}
	}();
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('post-edit-container')
			]),
		content);
};
var _user$project$View$renderPost = function (post) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(
				_elm_lang$core$Basics$toString(post.publishedAt))
			]));
};
var _user$project$View$prettyDate = function (time) {
	return A2(
		_elm_lang$core$String$join,
		'-',
		A2(
...
var _user$project$View$renderPostHeader = function (post) {
	return A2(
		_elm_lang$html$Html$li,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('posts-list-item posts-list-item__selected')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('posts-list-item--title'),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'posts-list-item--date', _1: true},
								{
								ctor: '_Tuple2',
								_0: 'posts-list-item--date__draft',
								_1: _user$project$View$isNothing(post.publishedAt)
							}
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							_elm_lang$core$Maybe$withDefault,
							'(draft)',
							A2(_user$project$View$lift, _user$project$View$prettyDate, post.publishedAt)))
					]))
			]));
};
var _user$project$View$renderPostsList = function (model) {
	var _p4 = model;
	if (_p4.ctor === 'Nothing') {
		return _elm_lang$html$Html$text('No posts fetched yet');
	} else {
		var sortedPosts = A2(
			_elm_lang$core$List$sortWith,
			_user$project$View$sortPublishedAt,
			_elm_lang$core$Dict$values(_p4._0));
		return A2(
			_elm_lang$html$Html$ul,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('posts-list')
				]),
			A2(_elm_lang$core$List$map, _user$project$View$renderPostHeader, sortedPosts));
	}
};
var _user$project$View$content = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('admin-content')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$View$renderPostsList(model.posts),
				_user$project$View$renderPostEdit(model.selectedPost)
			]));
};
var _user$project$View$controls = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('admin-controls')
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html$text('controls coming')
		]));
var _user$project$View$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('admin-container')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$View$controls,
				_user$project$View$content(model)
			]));
};
